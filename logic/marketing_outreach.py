...
class MarketingScenario(BaseScenario):
    ...
    async def _detect_intent(self, transcript: str) -> str:
        ...
        yes_tokens = {
            ...
            "وصل کنید", "دوره ایلتس", "دوره مکالمه", "دوره دکترا", "دوره ای پی تی",
            "ام اس ار تی", "پی تی ای", "ام اچ ال ای", "ترکی", "فرانسه", "آلمانی", "روسی",
            ...
            # Newly observed positives that were mis-bucketed
            "می شه سایتتون رو برا من بفرستید ببینم لطفا",
            "عربی به چه لهجه ای",
            "برای دوره های زبان انگلیسی به چه شکله بله",
            "ممنونم از بله",  # yes at the end of thanks
